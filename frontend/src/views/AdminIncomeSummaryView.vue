  ...
  autoTable(doc, {
    ...
    body: [
      ...rows.map((r) => [
        ...
        r.booking_ref,
        r.customer_name ?? "-",
        settingsStore.formatPrice(r.room_revenue),
        settingsStore.formatPrice(r.extra_revenue),
        settingsStore.formatPrice(r.discount_total),
        settingsStore.formatPrice(r.net_revenue),
      ]),
      [
        { content: `Total (${rows.length})`, colSpan: 3, styles: { fontStyle: "bold" } },
        { content: settingsStore.formatPrice(totalRoom), styles: { fontStyle: "bold" } },
        { content: settingsStore.formatPrice(totalExtra), styles: { fontStyle: "bold" } },
        { content: settingsStore.formatPrice(totalDiscount), styles: { fontStyle: "bold" } },
        { content: settingsStore.formatPrice(totalNet), styles: { fontStyle: "bold" } },
      ],
    ],
    styles: { fontSize: 8 },
